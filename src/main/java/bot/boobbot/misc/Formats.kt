...
object Formats {
    ...
    var LEWD_EMOTE = "<:TouchMaBooty:444601938320031745>"
    var DISCORD_EMOTE = "<:discord:486939267365470210>"
    var BOT_EMOTE = "<:bot:486939322151338005>"
    var LINK_EMOTE = "\uD83D\uDD17"
    var PAYPAL_EMOTE = "<:paypal:486945242369490945>"
    var MAGIC_EMOTE = "✨"
    var INFO_EMOTE = "<:info:486945488080338944>"
    var LING_MSG = MessageFormat.format(
    ...
    fun getFullName(msg: net.dv8tion.jda.core.entities.Message): String {
        return MessageFormat.format(
                "{0}#{1}", msg.author.name, msg.author.discriminator)
    }

    fun getEmoteID(text: String): Long {
