...
@CommandDescription(
        name = "SendNudesCommand",
        triggers = {"sendnudes", "sn"},
        attributes = {
                @CommandAttribute(key = "dm", value = "no")
        },
        description = "SendNudesCommand"
)
public class SendNudesCommand implements Command {
    @Override
                        ...
                        ((PrivateChannel pm) -> {
                            pm.sendMessage("hey!").queue(message -> {
                                ...
                                new ButtonMenu.Builder()
                                        ...
                                        .setDescription(
                                                Formats.info(
                                                        event.getMember().getEffectiveName() + " Has sent you some nudes, Are you 18+ and sure you want to continue?"))
                                        .setChoices(
                                                pm
                                                        .getJDA()
                                                        .asBot()
