...
/**
 * A {@link Menu Menu} implementation that creates a organized display of emotes/emojis as buttons
...
public class ButtonMenu extends Menu {
    ...
    /**
     * Shows the ButtonMenu as a new {@link Message Message} in the provided {@link MessageChannel
     * MessageChannel}.
     *
    ...
    /**
     * Displays this ButtonMenu by editing the provided {@link Message Message}.
     *
    ...
    /**
     * The {@link Menu.Builder Menu.Builder} for a {@link ButtonMenu ButtonMenu}.
     *
     * @author John Grosh
     */
    public static class Builder extends Menu.Builder<Builder, ButtonMenu> {
        ...
        /**
         * Builds the {@link ButtonMenu ButtonMenu} with this Builder.
         *
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed when the {@link ButtonMenu
         * ButtonMenu} is built.
         *
        ...
        /**
         * Sets the {@link Consumer Consumer} to perform if the {@link ButtonMenu ButtonMenu} is done,
         ...
         *
         * <p>Any non-unicode {@link Emote Emote} should be added using {@link
         * ButtonMenu.Builder#addChoice(Emote) ButtonMenu.Builder#addChoice(Emote)}.
         *
        ...
        /**
         * Adds a single custom {@link Emote Emote} as button choices.
         *
         ...
         *
         * <p>Any non-unicode {@link Emote Emote}s should be added using {@link
         * ButtonMenu.Builder#addChoices(Emote...) ButtonMenu.Builder#addChoices(Emote...)}.
         *
        ...
        /**
         * Adds custom {@link Emote Emote}s as button choices.
         *
         * <p>Any regular unicode emojis should be added using {@link
         ...
         *
         * <p>Any non-unicode {@link Emote Emote}s should be set using {@link
         * ButtonMenu.Builder#setChoices(Emote...) ButtonMenu.Builder#setChoices(Emote...)}.
         *
        ...
        /**
         * Sets the {@link Emote Emote}s as button choices.
         *
