...
/**
 * A {@link Menu Menu} of ordered buttons signified by numbers or letters, each with a reaction
 * linked to it for users to click.
 *
...
public class OrderedMenu extends Menu {
    ...
    /**
     * Shows the OrderedMenu as a new {@link Message Message} in the provided {@link MessageChannel
     * MessageChannel}.
     *
     ...
     *                                  <ul>
     *                                  <li>Being sent to a {@link TextChannel TextChannel}.
    ...
    /**
     * Displays this OrderedMenu by editing the provided {@link Message Message}.
     *
    ...
    /**
     * The {@link Menu.Builder Menu.Builder} for an {@link OrderedMenu OrderedMenu}.
     *
     * @author John Grosh
     */
    public static class Builder extends Menu.Builder<Builder, OrderedMenu> {
        ...
        /**
         * Builds the {@link OrderedMenu OrderedMenu} with this Builder.
         *
        ...
        /**
         * Sets the builder to build an {@link OrderedMenu OrderedMenu} using letters for ordering and
         * reactions (IE: A, B, C, etc.). <br>
        ...
        /**
         * Sets the builder to build an {@link OrderedMenu OrderedMenu} using numbers for ordering and
         * reactions (IE: A, B, C, etc.).
         *
         * @return This builder
         */
        ...
        /**
         * If {@code true}, {@link User User}s can type the number or letter of the input to make their
         * selection, in addition to the reaction option.
         *
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed when the {@link OrderedMenu
        ...
        /**
         * Sets the {@link Consumer Consumer} to perform if the {@link OrderedMenu OrderedMenu} is
         * cancelled.
         *
