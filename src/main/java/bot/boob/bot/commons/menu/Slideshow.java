...
/**
 * A {@link Menu Menu} implementation, nearly identical to {@link Paginator Paginator}, that
 * displays an individual image on each page instead of a list of text items.
 *
 * <p>Like Paginator, reaction functions allow the user to traverse to the last page using the left
 * arrow, the next page using the right arrow, and to stop the Slideshow prematurely using the stop
 * reaction.
 *
 * @author John Grosh
 */
public class Slideshow extends Menu {
    ...
    Slideshow(
            ...
            BiFunction<Integer, Integer, String> description,
    ...
    /**
     * Begins pagination on page 1 as a new {@link Message Message} in the provided {@link
    ...
    /**
     * Begins pagination on page 1 displaying this by editing the provided {@link Message Message}.
     *
    ...
    /**
     * Begins pagination as a new {@link Message Message} in the provided {@link MessageChannel
    ...
    public void paginate(MessageChannel channel, int pageNum) {
        ...
        else if (pageNum > urls.size()) pageNum = urls.size();
        Message msg = renderPage(pageNum);
        initialize(channel.sendMessage(msg), pageNum);
    }

    /**
     * Begins pagination displaying this by editing the provided {@link Message Message}, starting on
     * whatever page number is provided.
     *
    ...
    /**
     * The {@link Menu.Builder Menu.Builder} for a {@link Slideshow Slideshow}.
     *
     * @author John Grosh
     */
    public static class Builder extends Menu.Builder<Builder, Slideshow> {
        ...
        /**
         * Builds the {@link Slideshow Slideshow} with this Builder.
         *
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed when the {@link Slideshow
         * Slideshow} is built.
         *
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed relative to the total page
         * number and the current page as determined by the provided {@link BiFunction BiFunction}. <br>
         * As the page changes, the BiFunction will re-process the current page number and the total
         ...
         * As the page changes, the BiFunction will re-process the current page number and the total
         * page number, allowing for the displayed description of the MessageEmbed to change depending
         * on the page number.
         *
         * @param descriptionBiFunction The BiFunction that uses both current and total page numbers to
         *                              get description for the MessageEmbed
         * @return This builder
         */
        ...
        /**
         * Sets the {@link Consumer Consumer} to perform if the {@link Slideshow Slideshow} times out.
         *
        ...
        /**
         * Sets whether the {@link Slideshow Slideshow} will instantly timeout, and possibly run a
         * provided {@link Runnable Runnable}, if only a single slide is available to display.
         *
        ...
        /**
         * Sets the String list of urls to paginate. <br>
        ...
        /**
         * Sets the {@link Slideshow Slideshow}'s bulk-skip function to skip multiple pages using
         * alternate forward and backwards
         *
        ...
        /**
         * Sets the {@link Slideshow Slideshow} to wrap from the last page to the first when traversing
         * right and visa versa from the left.
         *
        ...
        /**
         * Sets the {@link Slideshow Slideshow} to allow a slide number to be specified by a user via
         * text.
         *
         ...
         * they will no longer be available when the Slideshow is built.
         *
