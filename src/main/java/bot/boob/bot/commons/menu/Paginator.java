...
/**
 * A {@link Menu Menu} implementation that paginates a set of one or more text items across one or
 * more pages.
 *
...
public class Paginator extends Menu {
    ...
    /**
     * Begins pagination on page 1 displaying this Pagination by editing the provided {@link Message
     * Message}.
     *
    ...
    /**
     * Begins pagination displaying this Pagination by editing the provided {@link Message Message},
    ...
    /**
     * The {@link Menu.Builder Menu.Builder} for a {@link Paginator Paginator}.
     *
     * @author John Grosh
     */
    public static class Builder extends Menu.Builder<Builder, Paginator> {
        ...
        /**
         * Builds the {@link Paginator Paginator} with this Builder.
         *
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed when the {@link Paginator
         * Paginator} is built.
         *
        ...
        /**
         * Sets the {@link Consumer Consumer} to perform if the {@link Paginator Paginator} times out.
         *
        ...
        /**
         * Sets whether the {@link Paginator Paginator} will instantly timeout, and possibly run a
        ...
        /**
         * Sets the {@link Paginator Paginator}'s bulk-skip function to skip multiple pages using
        ...
        /**
         * Sets the {@link Paginator Paginator} to wrap from the last page to the first when traversing
        ...
        /**
         * Sets the {@link Paginator Paginator} to allow a page number to be specified by a user via
         * text.
         *
        ...
        /**
         * Sets the {@link Paginator Paginator} to traverse left or right when a provided text input is
