package bot.boobbot.commands.meme.memes2
...
@CommandProperties(aliases = ["triggered"], description = "Trigger.", category = Category.MEME, guildOnly = true, groupByCategory = true)
