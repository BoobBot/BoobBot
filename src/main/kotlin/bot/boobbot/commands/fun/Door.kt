...
@CommandProperties(description = "Door.", nsfw = false, category = Category.FUN, guildOnly = true)
class Door : AsyncCommand {
    ...
    override suspend fun executeAsync(ctx: Context) {
        ...
        val res = BoobBot.requestUtil
            .get(
                "https://dankmemer.services/api/door?avatar1=${URLEncoder.encode(user.user.avatarUrl, Charsets.UTF_8.name())}",
