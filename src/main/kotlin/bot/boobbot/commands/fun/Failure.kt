...
@CommandProperties(description = "Failure.", nsfw = false, category = Category.FUN, guildOnly = true)
class Failure : AsyncCommand {
    ...
    override suspend fun executeAsync(ctx: Context) {
        ...
        val res = BoobBot.requestUtil
            .get(
                "https://dankmemer.services/api/failure?avatar1=${URLEncoder.encode(user.user.avatarUrl, Charsets.UTF_8.name())}",
