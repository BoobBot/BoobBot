...
@CommandProperties(description = "Fedora.", nsfw = false, category = Category.FUN, guildOnly = true, aliases = ["tip"])
class Fedora : AsyncCommand {
    ...
    override suspend fun executeAsync(ctx: Context) {
        ...
        val res = BoobBot.requestUtil
            .get(
                "https://dankmemer.services/api/fedora?avatar1=${URLEncoder.encode(user.user.avatarUrl, Charsets.UTF_8.name())}",
